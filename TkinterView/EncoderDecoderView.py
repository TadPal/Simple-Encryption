...
class EncoderDecoderView:
    def __init__(self, logic):
        ...
        Label(self.root, font="arial 12 bold", text="KEY").place(x=60, y=90)
        ...
        Button(self.root, font="arial 10 bold", text = "ENCODE", padx=2, bg="LimeGreen", width=8, height=2, command=self.encode).place(x=150, y=190)
        Button(self.root, font="arial 10 bold", text = "DECODE", padx=2, bg="OrangeRed", width=8, height=2, command=self.decode).place(x=270, y=190)
